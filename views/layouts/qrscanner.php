...
<head><meta charset="utf-8"><title>ATTENDANCE SCANNER</title>
...
<link href="<?=$directoryAsset?>/styles.css" rel="stylesheet"></head>
...
<?php //<div class="app__select-photos"><i class="fa fa-edit"></i></div> ?>
    ...
    function (e, t, n) {
        ...
        (a.active = !1),
            ...
            (a.init = () => {
                ...
                function i() {
                    (window.noCameraPermission = !0), (document.querySelector(".custom-scanner").style.display = "none"), o.snackbar.show("Unable to access the camera", 1e4);
                }
                r(),
                    a.setCanvas(),
                    (a.decoder = new Worker("<?php echo $directoryAsset?>/decoder.js")),
                    ...
                    window.isMediaStreamAPISupported &&
                        navigator.mediaDevices
                            ...
                            .then(function (e) {
                                ...
                                o.length > 1
                                    ? ((t = { video: { mandatory: { sourceId: o[o.length - 1].deviceId ? o[o.length - 1].deviceId : null } }, audio: !1 }), window.iOS && (t.video.facingMode = "environment"), n(t))
                                    : o.length
        ...
        "serviceWorker" in navigator &&
            window.addEventListener("load", () => {
                navigator.serviceWorker
                    ...
                    .then((e) => {
                        console.log("SW registered: ", e), localStorage.getItem("offline") || (localStorage.setItem("offline", !0), o.snackbar.show("App is ready for offline usage.", 5e3));
                    })
                    .catch((e) => {
            ...
            window.addEventListener("DOMContentLoaded", () => {
                ...
                function u(t = !1) {
                    ...
                    window.isMediaStreamAPISupported && !window.noCameraPermission && (l.style.display = "block"),
                        ...
                        i.scan((t) => {
							window.location.href = "<?=$url_result?>" + t;
                            /* (e = t), (s.value = t), s.select(), (l.style.display = "none"), d()(t) && (r.style.display = "inline-block"), o.classList.remove("app__dialog--hide"), a.classList.remove("app__dialog--hide");
                            document.querySelector("#frame"); */
                        }, t);
                }
                function m() {
                    (e = null), (s.value = ""), window.isMediaStreamAPISupported || ((t.src = ""), (t.className = "")), o.classList.add("app__dialog--hide"), a.classList.add("app__dialog--hide"), u();
                }
